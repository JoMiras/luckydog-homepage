...
function q(a,b){if(0!==b.byteLength)if(512<b.byteLength)0<l&&(a.enqueue(new Uint8Array(k.buffer,0,l)),k=new Uint8Array(512),l=0),a.enqueue(b);else{var c=k.length-l;c<b.byteLength&&(0===c?a.enqueue(k):(k.set(b.subarray(0,c),l),a.enqueue(k),b=b.subarray(c)),k=new Uint8Array(512),l=0);k.set(b,l);l+=b.byteLength}}function r(a,b){q(a,b);return!0}function ia(a){k&&0<l&&(a.enqueue(new Uint8Array(k.buffer,0,l)),k=null,l=0)}var ra=new TextEncoder;function v(a){return ra.encode(a)}
...
function Tb(a,b,c,d,e,f,g){var m=null;"function"===typeof c&&("function"===typeof c.$$FORM_ACTION?(d=Ob(b),b=c.$$FORM_ACTION(d),g=b.name,c=b.action||"",d=b.encType,e=b.method,f=b.target,m=b.data):(a.push(L,v("formAction"),M,Pb,J),f=e=d=c=g=null,$b(b)));null!=g&&R(a,"name",g);null!=c&&R(a,"formAction",c);null!=d&&R(a,"formEncType",d);null!=e&&R(a,"formMethod",e);null!=f&&R(a,"formTarget",f);return m}
...
c);break;case "xlinkArcrole":N(a,"xlink:arcrole",c);break;case "xlinkRole":N(a,"xlink:role",c);break;case "xlinkShow":N(a,"xlink:show",c);break;case "xlinkTitle":N(a,"xlink:title",c);break;case "xlinkType":N(a,"xlink:type",c);break;case "xmlBase":N(a,"xml:base",c);break;case "xmlLang":N(a,"xml:lang",c);break;case "xmlSpace":N(a,"xml:space",c);break;default:if(!(2<b.length)||"o"!==b[0]&&"O"!==b[0]||"n"!==b[1]&&"N"!==b[1])if(b=Da.get(b)||b,Ba(b)){switch(typeof c){case "function":case "symbol":return;
case "boolean":var d=b.toLowerCase().slice(0,5);if("data-"!==d&&"aria-"!==d)return}a.push(L,v(b),M,v(A(c)),J)}}}var S=x(">"),Sb=x("/>");function ac(a,b,c){if(null!=b){if(null!=c)throw Error(h(60));if("object"!==typeof b||!("__html"in b))throw Error(h(61));b=b.__html;null!==b&&void 0!==b&&a.push(v(""+b))}}function bc(a){var b="";aa.Children.forEach(a,function(c){null!=c&&(b+=c)});return b}var cc=x(' selected=""'),dc=x('addEventListener("submit",function(a){if(!a.defaultPrevented){var c=a.target,d=a.submitter,e=c.action,b=d;if(d){var f=d.getAttribute("formAction");null!=f&&(e=f,b=null)}"javascript:throw new Error(\'A React form was unexpectedly submitted.\')"===e&&(a.preventDefault(),b?(a=document.createElement("input"),a.name=b.name,a.value=b.value,b.parentNode.insertBefore(a,b),b=new FormData(c),a.parentNode.removeChild(a)):b=new FormData(c),a=c.getRootNode(),(a.$$reactFormReplay=a.$$reactFormReplay||[]).push(c,\nd,b))}});');
...
function hc(a,b){a.push(T("title"));var c=null,d=null,e;for(e in b)if(y.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:R(a,e,f)}}a.push(S);b=Array.isArray(c)?2>c.length?c[0]:null:c;"function"!==typeof b&&"symbol"!==typeof b&&null!==b&&void 0!==b&&a.push(v(A(""+b)));ac(a,d,c);a.push(ic,v("title"),jc);return null}
function Cb(a,b){a.push(T("script"));var c=null,d=null,e;for(e in b)if(y.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:R(a,e,f)}}a.push(S);ac(a,d,c);"string"===typeof c&&a.push(v(A(c)));a.push(ic,v("script"),jc);return null}
function kc(a,b,c){a.push(T(c));var d=c=null,e;for(e in b)if(y.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:R(a,e,f)}}a.push(S);ac(a,d,c);return"string"===typeof c?(a.push(v(A(c))),null):c}var lc=x("\n"),mc=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,nc=new Map;function T(a){var b=nc.get(a);if(void 0===b){if(!mc.test(a))throw Error(h(65,a));b=x("<"+a);nc.set(a,b)}return b}var oc=x("<!DOCTYPE html>");
...
u)){var D=c[u];if(null!=D)switch(u){case "children":w=D;break;case "selected":I=D;break;case "dangerouslySetInnerHTML":E=D;break;case "value":H=D;default:R(a,u,D)}}if(null!=t){var O=null!==H?""+H:bc(w);if(Ma(t))for(var ba=0;ba<t.length;ba++){if(""+t[ba]===O){a.push(cc);break}}else""+t===O&&a.push(cc)}else I&&a.push(cc);a.push(S);ac(a,E,w);return w;case "textarea":a.push(T("textarea"));var K=null,P=null,B=null,C;for(C in c)if(y.call(c,C)){var ja=c[C];if(null!=ja)switch(C){case "children":B=ja;break;
case "value":K=ja;break;case "defaultValue":P=ja;break;case "dangerouslySetInnerHTML":throw Error(h(91));default:R(a,C,ja)}}null===K&&null!==P&&(K=P);a.push(S);if(null!=B){if(null!=K)throw Error(h(92));if(Ma(B)&&1<B.length)throw Error(h(93));K=""+B}"string"===typeof K&&"\n"===K[0]&&a.push(lc);null!==K&&a.push(v(A(""+K)));return null;case "input":a.push(T("input"));var Ea=null,wa=null,ka=null,ea=null,xa=null,la=null,ma=null,na=null,Fa=null,ca;for(ca in c)if(y.call(c,ca)){var Y=c[ca];if(null!=Y)switch(ca){case "children":case "dangerouslySetInnerHTML":throw Error(h(399,
"input"));case "name":Ea=Y;break;case "formAction":wa=Y;break;case "formEncType":ka=Y;break;case "formMethod":ea=Y;break;case "formTarget":xa=Y;break;case "defaultChecked":Fa=Y;break;case "defaultValue":ma=Y;break;case "checked":na=Y;break;case "value":la=Y;break;default:R(a,ca,Y)}}var Oc=Tb(a,e,wa,ka,ea,xa,Ea);null!==na?Nb(a,"checked",na):null!==Fa&&Nb(a,"checked",Fa);null!==la?R(a,"value",la):null!==ma&&R(a,"value",ma);a.push(Sb);null!==Oc&&Oc.forEach(Rb,a);return null;case "button":a.push(T("button"));
var Qa=null,Pc=null,Qc=null,Rc=null,Sc=null,Tc=null,Uc=null,Ra;for(Ra in c)if(y.call(c,Ra)){var fa=c[Ra];if(null!=fa)switch(Ra){case "children":Qa=fa;break;case "dangerouslySetInnerHTML":Pc=fa;break;case "name":Qc=fa;break;case "formAction":Rc=fa;break;case "formEncType":Sc=fa;break;case "formMethod":Tc=fa;break;case "formTarget":Uc=fa;break;default:R(a,Ra,fa)}}var Vc=Tb(a,e,Rc,Sc,Tc,Uc,Qc);a.push(S);null!==Vc&&Vc.forEach(Rb,a);ac(a,Pc,Qa);if("string"===typeof Qa){a.push(v(A(Qa)));var Wc=null}else Wc=
Qa;return Wc;case "form":a.push(T("form"));var Sa=null,Xc=null,oa=null,Ta=null,Ua=null,Va=null,Wa;for(Wa in c)if(y.call(c,Wa)){var pa=c[Wa];if(null!=pa)switch(Wa){case "children":Sa=pa;break;case "dangerouslySetInnerHTML":Xc=pa;break;case "action":oa=pa;break;case "encType":Ta=pa;break;case "method":Ua=pa;break;case "target":Va=pa;break;default:R(a,Wa,pa)}}var Ub=null,Vb=null;if("function"===typeof oa)if("function"===typeof oa.$$FORM_ACTION){var Ie=Ob(e),Ga=oa.$$FORM_ACTION(Ie);oa=Ga.action||"";Ta=
Ga.encType;Ua=Ga.method;Va=Ga.target;Ub=Ga.data;Vb=Ga.name}else a.push(L,v("action"),M,Pb,J),Va=Ua=Ta=oa=null,$b(e);null!=oa&&R(a,"action",oa);null!=Ta&&R(a,"encType",Ta);null!=Ua&&R(a,"method",Ua);null!=Va&&R(a,"target",Va);a.push(S);null!==Vb&&(a.push(Qb),N(a,"name",Vb),a.push(Sb),null!==Ub&&Ub.forEach(Rb,a));ac(a,Xc,Sa);if("string"===typeof Sa){a.push(v(A(Sa)));var Yc=null}else Yc=Sa;return Yc;case "menuitem":a.push(T("menuitem"));for(var nb in c)if(y.call(c,nb)){var Zc=c[nb];if(null!=Zc)switch(nb){case "children":case "dangerouslySetInnerHTML":throw Error(h(400));
default:R(a,nb,Zc)}}a.push(S);return null;case "title":if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp)var $c=hc(a,c);else hc(e.hoistableChunks,c),$c=null;return $c;case "link":return ec(a,c,e,d,g,f.insertionMode,f.noscriptTagInScope);case "script":var Wb=c.async;if("string"!==typeof c.src||!c.src||!Wb||"function"===typeof Wb||"symbol"===typeof Wb||c.onLoad||c.onError||3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp)var ad=Cb(a,c);else{var Xb="[script]"+c.src,Xa=d.scriptsMap.get(Xb);
if(!Xa){Xa={type:"script",chunks:[],state:0,props:null};d.scriptsMap.set(Xb,Xa);d.scripts.add(Xa);var bd=c,ob=d.preloadsMap.get(Xb);if(ob){ob.state|=4;var pb=bd=ta({},c),cd=ob.props;null==pb.crossOrigin&&(pb.crossOrigin=cd.crossOrigin);null==pb.integrity&&(pb.integrity=cd.integrity)}Cb(Xa.chunks,bd)}g&&a.push(Fb);ad=null}return ad;case "style":var Ya=c.precedence,Za=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof Ya||"string"!==typeof Za||""===Za){a.push(T("style"));
var Ha=null,dd=null,$a;for($a in c)if(y.call(c,$a)){var qb=c[$a];if(null!=qb)switch($a){case "children":Ha=qb;break;case "dangerouslySetInnerHTML":dd=qb;break;default:R(a,$a,qb)}}a.push(S);var ab=Array.isArray(Ha)?2>Ha.length?Ha[0]:null:Ha;"function"!==typeof ab&&"symbol"!==typeof ab&&null!==ab&&void 0!==ab&&a.push(v(A(""+ab)));ac(a,dd,Ha);a.push(ic,v("style"),jc);var ed=null}else{var fd="[style]"+Za,ha=d.stylesMap.get(fd);if(!ha){if(ha=d.stylePrecedences.get(Ya))ha.props.hrefs.push(Za);else{ha={type:"style",
chunks:[],state:0,props:{precedence:Ya,hrefs:[Za]}};d.stylePrecedences.set(Ya,ha);var gd=new Set;gd.add(ha);d.precedences.set(Ya,gd)}d.stylesMap.set(fd,ha);d.boundaryResources&&d.boundaryResources.add(ha);var hd=ha.chunks,Ia=null,id=null,rb;for(rb in c)if(y.call(c,rb)){var Yb=c[rb];if(null!=Yb)switch(rb){case "children":Ia=Yb;break;case "dangerouslySetInnerHTML":id=Yb}}var bb=Array.isArray(Ia)?2>Ia.length?Ia[0]:null:Ia;"function"!==typeof bb&&"symbol"!==typeof bb&&null!==bb&&void 0!==bb&&hd.push(v(A(""+
bb)));ac(hd,id,Ia)}g&&a.push(Fb);ed=void 0}return ed;case "meta":if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp)var jd=gc(a,c,"meta");else g&&a.push(Fb),jd="string"===typeof c.charSet?gc(e.charsetChunks,c,"meta"):"viewport"===c.name?gc(e.preconnectChunks,c,"meta"):gc(e.hoistableChunks,c,"meta");return jd;case "listing":case "pre":a.push(T(b));var cb=null,db=null,eb;for(eb in c)if(y.call(c,eb)){var sb=c[eb];if(null!=sb)switch(eb){case "children":cb=sb;break;case "dangerouslySetInnerHTML":db=
sb;break;default:R(a,eb,sb)}}a.push(S);if(null!=db){if(null!=cb)throw Error(h(60));if("object"!==typeof db||!("__html"in db))throw Error(h(61));var ya=db.__html;null!==ya&&void 0!==ya&&("string"===typeof ya&&0<ya.length&&"\n"===ya[0]?a.push(lc,v(ya)):a.push(v(""+ya)))}"string"===typeof cb&&"\n"===cb[0]&&a.push(lc);return cb;case "img":var U=c.src,Q=c.srcSet;if("lazy"!==c.loading&&("string"===typeof U||"string"===typeof Q)&&"low"!==c.fetchPriority&&("string"!==typeof U||":"!==U[4]||"d"!==U[0]&&"D"!==
U[0]||"a"!==U[1]&&"A"!==U[1]||"t"!==U[2]&&"T"!==U[2]||"a"!==U[3]&&"A"!==U[3])&&("string"!==typeof Q||":"!==Q[4]||"d"!==Q[0]&&"D"!==Q[0]||"a"!==Q[1]&&"A"!==Q[1]||"t"!==Q[2]&&"T"!==Q[2]||"a"!==Q[3]&&"A"!==Q[3])){var kd=c.sizes,ld=fc(U,Q,kd),za=d.preloadsMap.get(ld);za||(za={type:"preload",chunks:[],state:0,props:{rel:"preload",as:"image",href:Q?void 0:U,imageSrcSet:Q,imageSizes:kd,crossOrigin:c.crossOrigin,integrity:c.integrity,type:c.type,fetchPriority:c.fetchPriority,referrerPolicy:c.referrerPolicy}},
...
f.insertionMode&&null===e.headChunks){e.headChunks=[];var md=kc(e.headChunks,c,"head")}else md=kc(a,c,"head");return md;case "html":if(0===f.insertionMode&&null===e.htmlChunks){e.htmlChunks=[oc];var nd=kc(e.htmlChunks,c,"html")}else nd=kc(a,c,"html");return nd;default:if(-1!==b.indexOf("-")){a.push(T(b));var Zb=null,od=null,qa;for(qa in c)if(y.call(c,qa)){var W=c[qa];if(null!=W&&"function"!==typeof W&&"object"!==typeof W&&!1!==W)switch(!0===W&&(W=""),"className"===qa&&(qa="class"),qa){case "children":Zb=
W;break;case "dangerouslySetInnerHTML":od=W;break;case "style":Lb(a,W);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;default:Ba(qa)&&"function"!==typeof W&&"symbol"!==typeof W&&a.push(L,v(qa),M,v(A(W)),J)}}a.push(S);ac(a,od,Zb);return Zb}}return kc(a,c,b)}var ic=x("</"),jc=x(">");function qc(a,b){b=b.bootstrapChunks;for(var c=0;c<b.length-1;c++)q(a,b[c]);return c<b.length?(c=b[c],b.length=0,r(a,c)):!0}
var rc=x('<template id="'),sc=x('"></template>'),tc=x("\x3c!--$--\x3e"),uc=x('\x3c!--$?--\x3e<template id="'),vc=x('"></template>'),wc=x("\x3c!--$!--\x3e"),xc=x("\x3c!--/$--\x3e"),yc=x("<template"),zc=x('"'),Ac=x(' data-dgst="');x(' data-msg="');x(' data-stck="');var Bc=x("></template>");function Cc(a,b,c){q(a,uc);if(null===c)throw Error(h(395));q(a,c);return r(a,vc)}
var Dc=x('<div hidden id="'),Ec=x('">'),Fc=x("</div>"),Gc=x('<svg aria-hidden="true" style="display:none" id="'),Hc=x('">'),Ic=x("</svg>"),Jc=x('<math aria-hidden="true" style="display:none" id="'),Kc=x('">'),Lc=x("</math>"),Mc=x('<table hidden id="'),Nc=x('">'),pd=x("</table>"),qd=x('<table hidden><tbody id="'),rd=x('">'),sd=x("</tbody></table>"),td=x('<table hidden><tr id="'),ud=x('">'),vd=x("</tr></table>"),wd=x('<table hidden><colgroup id="'),xd=x('">'),yd=x("</colgroup></table>");
function zd(a,b,c,d){switch(c.insertionMode){case 0:case 1:case 2:return q(a,Dc),q(a,b.segmentPrefix),q(a,v(d.toString(16))),r(a,Ec);case 3:return q(a,Gc),q(a,b.segmentPrefix),q(a,v(d.toString(16))),r(a,Hc);case 4:return q(a,Jc),q(a,b.segmentPrefix),q(a,v(d.toString(16))),r(a,Kc);case 5:return q(a,Mc),q(a,b.segmentPrefix),q(a,v(d.toString(16))),r(a,Nc);case 6:return q(a,qd),q(a,b.segmentPrefix),q(a,v(d.toString(16))),r(a,rd);case 7:return q(a,td),q(a,b.segmentPrefix),q(a,v(d.toString(16))),r(a,ud);
case 8:return q(a,wd),q(a,b.segmentPrefix),q(a,v(d.toString(16))),r(a,xd);default:throw Error(h(397));}}function Ad(a,b){switch(b.insertionMode){case 0:case 1:case 2:return r(a,Fc);case 3:return r(a,Ic);case 4:return r(a,Lc);case 5:return r(a,pd);case 6:return r(a,sd);case 7:return r(a,vd);case 8:return r(a,yd);default:throw Error(h(397));}}
...
var ge=x('<style media="not all" data-precedence="'),he=x('" data-href="'),ie=x('">'),je=x("</style>"),ke=!1,le=!0;function me(a){if("stylesheet"===a.type&&0===(a.state&1))ke=!0;else if("style"===a.type){var b=a.chunks,c=a.props.hrefs,d=0;if(b.length){q(this,ge);q(this,v(A(a.props.precedence)));if(c.length){for(q(this,he);d<c.length-1;d++)q(this,v(A(c[d]))),q(this,ne);q(this,v(A(c[d])))}q(this,ie);for(d=0;d<b.length;d++)q(this,b[d]);le=r(this,je);ke=!0;b.length=0;c.length=0}}}
...
var ue=x('<style data-precedence="'),ve=x('" data-href="'),ne=x(" "),we=x('">'),xe=x("</style>");function ye(a,b){se=!1;a.forEach(te,this);a.clear();a=re.chunks;var c=re.props.hrefs;if(!1===se||a.length){q(this,ue);q(this,v(A(b)));b=0;if(c.length){for(q(this,ve);b<c.length-1;b++)q(this,v(A(c[b]))),q(this,ne);q(this,v(A(c[b])))}q(this,we);for(b=0;b<a.length;b++)q(this,a[b]);q(this,xe);a.length=0;c.length=0}}
...
function Fe(a,b){q(a,Be);var c=Be;b.forEach(function(d){if("style"!==d.type&&!(d.state&1))if(d.state&3)q(a,c),q(a,v(fe(""+d.props.href))),q(a,Ee),c=Ce;else if("stylesheet"===d.type){q(a,c);var e=d.props["data-precedence"],f=d.props;q(a,v(fe(""+d.props.href)));e=""+e;q(a,De);q(a,v(fe(e)));for(var g in f)if(y.call(f,g)){var m=f[g];if(null!=m)switch(g){case "href":case "rel":case "precedence":case "data-precedence":break;case "children":case "dangerouslySetInnerHTML":throw Error(h(399,"link"));default:a:{e=
a;var n=g.toLowerCase();switch(typeof m){case "function":case "symbol":break a}switch(g){case "innerHTML":case "dangerouslySetInnerHTML":case "suppressContentEditableWarning":case "suppressHydrationWarning":case "style":break a;case "className":n="class";m=""+m;break;case "hidden":if(!1===m)break a;m="";break;case "src":case "href":m=""+m;break;default:if(2<g.length&&("o"===g[0]||"O"===g[0])&&("n"===g[1]||"N"===g[1])||!Ba(g))break a;m=""+m}q(e,De);q(e,v(fe(n)));q(e,De);q(e,v(fe(m)))}}}q(a,Ee);c=Ce;
d.state|=2}});q(a,Ee)}
function Ge(a,b){q(a,Be);var c=Be;b.forEach(function(d){if("style"!==d.type&&!(d.state&1))if(d.state&3)q(a,c),q(a,v(A(JSON.stringify(""+d.props.href)))),q(a,Ee),c=Ce;else if("stylesheet"===d.type){q(a,c);var e=d.props["data-precedence"],f=d.props;q(a,v(A(JSON.stringify(""+d.props.href))));e=""+e;q(a,De);q(a,v(A(JSON.stringify(e))));for(var g in f)if(y.call(f,g)){var m=f[g];if(null!=m)switch(g){case "href":case "rel":case "precedence":case "data-precedence":break;case "children":case "dangerouslySetInnerHTML":throw Error(h(399,"link"));
default:a:{e=a;var n=g.toLowerCase();switch(typeof m){case "function":case "symbol":break a}switch(g){case "innerHTML":case "dangerouslySetInnerHTML":case "suppressContentEditableWarning":case "suppressHydrationWarning":case "style":break a;case "className":n="class";m=""+m;break;case "hidden":if(!1===m)break a;m="";break;case "src":case "href":m=""+m;break;default:if(2<g.length&&("o"===g[0]||"O"===g[0])&&("n"===g[1]||"N"===g[1])||!Ba(g))break a;m=""+m}q(e,De);q(e,v(A(JSON.stringify(n))));q(e,De);
q(e,v(A(JSON.stringify(m))))}}}q(a,Ee);c=Ce;d.state|=2}});q(a,Ee)}function fb(a){var b=V?V:null;if(b){var c=b.resources;if("string"===typeof a&&a){var d="[prefetchDNS]"+a,e=c.preconnectsMap.get(d);e||(e={type:"preconnect",chunks:[],state:0,props:null},c.preconnectsMap.set(d,e),F(e.chunks,{href:a,rel:"dns-prefetch"}));c.preconnects.add(e);He(b)}}}
...
function kg(a,b,c,d,e,f,g,m,n,p){Pa.current=jb;var z=[],t=new Set;b={destination:null,flushScheduled:!1,responseState:c,progressiveChunkSize:void 0===e?12800:e,status:0,fatalError:null,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,resources:b,completedRootSegment:null,abortableTasks:t,pingedTasks:z,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===f?ig:f,onAllReady:void 0===g?jg:g,onShellReady:void 0===m?jg:m,onShellError:void 0===n?jg:n,onFatalError:void 0===
p?jg:p};d=lg(b,0,null,d,!1,!1);d.parentFlushed=!0;a=mg(b,null,a,null,d,t,ff,null,rf);z.push(a);return b}var V=null;function mg(a,b,c,d,e,f,g,m,n){a.allPendingTasks++;null===d?a.pendingRootTasks++:d.pendingTasks++;var p={node:c,ping:function(){a.pingedTasks.push(p);1===a.pingedTasks.length&&(a.flushScheduled=null!==a.destination,ng(a))},blockedBoundary:d,blockedSegment:e,abortSet:f,legacyContext:g,context:m,treeContext:n,thenableState:b};f.add(p);return p}
...
f.insertionMode){a.responseState.hasBody=!0;break a}break;case "html":if(0===f.insertionMode)break a}b.push(ic,v(d),jc)}c.lastPushedText=!1}else{switch(d){case $e:case Ye:case Ne:case Oe:case Me:Z(a,b,null,e.children);return;case Ze:"hidden"!==e.mode&&Z(a,b,null,e.children);return;case Ue:Z(a,b,null,e.children);return;case Xe:throw Error(h(343));case Te:a:{d=b.blockedBoundary;c=b.blockedSegment;f=e.fallback;e=e.children;g=new Set;var m={id:null,rootSegmentID:-1,parentFlushed:!1,pendingTasks:0,forceClientRender:!1,
...
b.parentFlushed&&a.partialBoundaries.push(b)));a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onAllReady,a())}
function ng(a){if(2!==a.status){var b=hf,c=gg.current;gg.current=eg;var d=hg.current;hg.current=fg;var e=V;V=a;var f=dg;dg=a.responseState;try{var g=a.pingedTasks,m;for(m=0;m<g.length;m++){var n=g[m];var p=a,z=n.blockedBoundary;p.resources.boundaryResources=z?z.resources:null;var t=n.blockedSegment;if(0===t.status){of(n.context);var w=t.children.length,H=t.chunks.length;try{var I=n.thenableState;n.thenableState=null;Z(p,n,I,n.node);t.lastPushedText&&t.textEmbedded&&t.chunks.push(Fb);n.abortSet.delete(n);
t.status=1;xg(p,n.blockedBoundary,t)}catch(B){Sf();t.children.length=w;t.chunks.length=H;var E=B===xf?Bf():B;if("object"===typeof E&&null!==E&&"function"===typeof E.then){var u=n.ping;E.then(u,u);n.thenableState=Tf()}else{n.abortSet.delete(n);t.status=4;var D=p,O=n.blockedBoundary,ba=E,K=og(D,ba);null===O?pg(D,ba):(O.pendingTasks--,O.forceClientRender||(O.forceClientRender=!0,O.errorDigest=K,O.parentFlushed&&D.clientRenderedBoundaries.push(O)));D.allPendingTasks--;if(0===D.allPendingTasks){var P=
D.onAllReady;P()}}}finally{p.resources.boundaryResources=null}}}g.splice(0,m);null!==a.destination&&zg(a,a.destination)}catch(B){og(a,B),pg(a,B)}finally{dg=f,gg.current=c,hg.current=d,c===eg&&of(b),V=e}}}
function Ag(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;q(b,rc);q(b,a.placeholderPrefix);a=v(d.toString(16));q(b,a);return r(b,sc);case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var g=0;g<c.length;g++){for(e=c[g];f<e.index;f++)q(b,d[f]);e=Bg(a,b,e)}for(;f<d.length-1;f++)q(b,d[f]);f<d.length&&(e=r(b,d[f]));return e;default:throw Error(h(390));}}
function Bg(a,b,c){var d=c.boundary;if(null===d)return Ag(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)d=d.errorDigest,r(b,wc),q(b,yc),d&&(q(b,Ac),q(b,v(A(d))),q(b,zc)),r(b,Bc),Ag(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var f=e.nextSuspenseID++;e=x(e.boundaryPrefix+f.toString(16));d=d.id=e;Cc(b,a.responseState,d);Ag(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,
a.completedBoundaries.push(d),Cc(b,a.responseState,d.id),Ag(a,b,c);else{(c=a.resources.boundaryResources)&&d.resources.forEach(Je,c);r(b,tc);c=d.completedSegments;if(1!==c.length)throw Error(h(391));Bg(a,b,c[0])}return r(b,xc)}function Cg(a,b,c){zd(b,a.responseState,c.formatContext,c.id);Bg(a,b,c);return Ad(b,c.formatContext)}
function Dg(a,b,c){a.resources.boundaryResources=c.resources;for(var d=c.completedSegments,e=0;e<d.length;e++)Eg(a,b,c,d[e]);d.length=0;oe(b,c.resources,a.responseState);a=a.responseState;d=c.id;e=c.rootSegmentID;c=c.resources;var f=a.stylesToHoist;a.stylesToHoist=!1;var g=0===a.streamingFormat;g?(q(b,a.startInlineScript),f?0===(a.instructions&2)?(a.instructions|=10,q(b,512<Jd.byteLength?Jd.slice():Jd)):0===(a.instructions&8)?(a.instructions|=8,q(b,Kd)):q(b,Ld):0===(a.instructions&2)?(a.instructions|=
2,q(b,Hd)):q(b,Id)):f?q(b,Rd):q(b,Qd);if(null===d)throw Error(h(395));e=v(e.toString(16));q(b,d);g?q(b,Md):q(b,Sd);q(b,a.segmentPrefix);q(b,e);f?g?(q(b,Nd),Fe(b,c)):(q(b,Td),Ge(b,c)):g&&q(b,Od);d=g?r(b,Pd):r(b,kb);return qc(b,a)&&d}
function Eg(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error(h(392));return Cg(a,b,d)}Cg(a,b,d);a=a.responseState;(c=0===a.streamingFormat)?(q(b,a.startInlineScript),0===(a.instructions&1)?(a.instructions|=1,q(b,Bd)):q(b,Cd)):q(b,Fd);q(b,a.segmentPrefix);e=v(e.toString(16));q(b,e);c?q(b,Dd):q(b,Gd);q(b,a.placeholderPrefix);q(b,e);b=c?r(b,Ed):r(b,kb);return b}
...
q(b,S)}else if(t)for(g=0;g<t.length;g++)q(b,t[g]);var w=f.charsetChunks;for(g=0;g<w.length;g++)q(b,w[g]);w.length=0;e.preconnects.forEach(pe,b);e.preconnects.clear();var H=f.preconnectChunks;for(g=0;g<H.length;g++)q(b,H[g]);H.length=0;e.fontPreloads.forEach(pe,b);e.fontPreloads.clear();e.highImagePreloads.forEach(pe,b);e.highImagePreloads.clear();e.precedences.forEach(ye,b);e.bootstrapScripts.forEach(pe,b);e.scripts.forEach(pe,b);e.scripts.clear();e.bulkPreloads.forEach(pe,b);e.bulkPreloads.clear();
var I=f.preloadChunks;for(g=0;g<I.length;g++)q(b,I[g]);I.length=0;var E=f.hoistableChunks;for(g=0;g<E.length;g++)q(b,E[g]);E.length=0;z&&null===t&&(q(b,ic),q(b,v("head")),q(b,jc));Bg(a,b,d);a.completedRootSegment=null;qc(b,a.responseState)}else return;else if(0<a.pendingRootTasks)return;var u=a.resources,D=a.responseState;d=0;u.preconnects.forEach(qe,b);u.preconnects.clear();var O=D.preconnectChunks;for(d=0;d<O.length;d++)q(b,O[d]);O.length=0;u.fontPreloads.forEach(qe,b);u.fontPreloads.clear();u.highImagePreloads.forEach(pe,
b);u.highImagePreloads.clear();u.precedences.forEach(Ae,b);u.scripts.forEach(qe,b);u.scripts.clear();u.bulkPreloads.forEach(qe,b);u.bulkPreloads.clear();var ba=D.preloadChunks;for(d=0;d<ba.length;d++)q(b,ba[d]);ba.length=0;var K=D.hoistableChunks;for(d=0;d<K.length;d++)q(b,K[d]);K.length=0;var P=a.clientRenderedBoundaries;for(c=0;c<P.length;c++){var B=P[c];u=b;var C=a.responseState,ja=B.id,Ea=B.errorDigest,wa=B.errorMessage,ka=B.errorComponentStack,ea=0===C.streamingFormat;ea?(q(u,C.startInlineScript),
0===(C.instructions&4)?(C.instructions|=4,q(u,Ud)):q(u,Vd)):q(u,Zd);if(null===ja)throw Error(h(395));q(u,ja);ea&&q(u,Wd);if(Ea||wa||ka)ea?(q(u,Xd),q(u,v(de(Ea||"")))):(q(u,$d),q(u,v(A(Ea||""))));if(wa||ka)ea?(q(u,Xd),q(u,v(de(wa||"")))):(q(u,ae),q(u,v(A(wa||""))));ka&&(ea?(q(u,Xd),q(u,v(de(ka)))):(q(u,be),q(u,v(A(ka)))));if(ea?!r(u,Yd):!r(u,kb)){a.destination=null;c++;P.splice(0,c);return}}P.splice(0,c);var xa=a.completedBoundaries;for(c=0;c<xa.length;c++)if(!Dg(a,b,xa[c])){a.destination=null;c++;
xa.splice(0,c);return}xa.splice(0,c);ia(b);k=new Uint8Array(512);l=0;var la=a.partialBoundaries;for(c=0;c<la.length;c++){var ma=la[c];a:{P=a;B=b;P.resources.boundaryResources=ma.resources;var na=ma.completedSegments;for(C=0;C<na.length;C++)if(!Eg(P,B,ma,na[C])){C++;na.splice(0,C);var Fa=!1;break a}na.splice(0,C);Fa=oe(B,ma.resources,P.responseState)}if(!Fa){a.destination=null;c++;la.splice(0,c);return}}la.splice(0,c);var ca=a.completedBoundaries;for(c=0;c<ca.length;c++)if(!Dg(a,b,ca[c])){a.destination=
null;c++;ca.splice(0,c);return}ca.splice(0,c)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length?(a.flushScheduled=!1,a=a.responseState,a.hasBody&&(q(b,ic),q(b,v("body")),q(b,jc)),a.htmlChunks&&(q(b,ic),q(b,v("html")),q(b,jc)),ia(b),b.close()):ia(b)}}function He(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;zg(a,b)}}
...
exports.prerender=function(a,b){return new Promise(function(c,d){var e={preloadsMap:new Map,preconnectsMap:new Map,stylesMap:new Map,scriptsMap:new Map,preconnects:new Set,fontPreloads:new Set,highImagePreloads:new Set,precedences:new Map,stylePrecedences:new Map,bootstrapScripts:new Set,scripts:new Set,bulkPreloads:new Set,boundaryResources:null},f=kg(a,e,Bb(e,b?b.identifierPrefix:void 0,void 0,b?b.bootstrapScriptContent:void 0,b?b.bootstrapScripts:void 0,b?b.bootstrapModules:void 0,b?b.unstable_externalRuntimeSrc:
void 0),Db(b?b.namespaceURI:void 0),b?b.progressiveChunkSize:void 0,b?b.onError:void 0,function(){var n={prelude:new ReadableStream({type:"bytes",pull:function(p){if(1===f.status)f.status=2,sa(p,f.fatalError);else if(2!==f.status&&null===f.destination){f.destination=p;try{zg(f,p)}catch(z){og(f,z),pg(f,z)}}}},{highWaterMark:0})};c(n)},void 0,void 0,d);if(b&&b.signal){var g=b.signal;if(g.aborted)Fg(f,g.reason);else{var m=function(){Fg(f,g.reason);g.removeEventListener("abort",m)};g.addEventListener("abort",
m)}}f.flushScheduled=null!==f.destination;ng(f)})};exports.version="18.3.0-experimental-1a001dac6-20230812";
>>>>>>> origin/dev_branch
